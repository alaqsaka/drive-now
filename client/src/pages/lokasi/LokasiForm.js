...
function LokasiForm() {
	...
	if (editMode) {
		setValue("name", lokasi.name);
		setValue("description", lokasi.description);
		setValue("personInChargeName", lokasi.personInChargeName);
		setValue("personInChargePhone", lokasi.personInChargePhone);
	}
	useEffect(() => {
		if (editMode) {
